...
### Fixed
- Version number now properly visible in GUI (moved higher up in footer)
- Settings now persist correctly in bundled .app package
- Configuration file saved to user home directory when running as bundle

### Changed
- Config manager detects PyInstaller frozen state and saves to home directory
- Version footer layout improved with separate frame for better positioning
